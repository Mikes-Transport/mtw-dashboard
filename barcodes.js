...
* DEFAULT FONT SIZES
*
* These are independent for each template.
  */
 ...
 * IMPORT CSV
 *
 * Exact Webflow button class supplied:
...
style.textContent = `
   ...
   * BARCODE
   *
   * Give the barcode its own controlled area.
   * This prevents larger barcode fonts from
   * visually running into the description.
   */
  .barcode-populate {
...
*
* Xlarge:
* * maximum 83 characters
* * adds ... when shortened
*
* Other templates have no character limit.
  */
...
if (barcode) {
  ...
  /*
   * Use a controlled line-height and
   * physical height so the barcode doesn't
   * collapse into the description.
   */
    ...
    reader.onload =
      () => {
        ...
        try {
          ...
          /*
           * Only ask about descriptions if
           * the CSV actually contains the column.
           */
          if (hasDescription) {
